// script.js completo para TransIberia con inputs integrados
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .getElementById("btnEnviarDatosInputs")
    ?.addEventListener("click", function () {
...
function obtenerValorInputCiudadOrigen() {
  inputCiudadOrigen = document
    .getElementById("idInputCiudadOrigen")
    .value.toLowerCase();
...
function obtenerValorInputCiudadDestino() {
  inputCiudadDestino = document
    .getElementById("idInputCiudadDestino")
    .value.toLowerCase();

  if (inputCiudadDestino === "") {
    alert("Introduzca una ciudad de destino");
  } else {
    return inputCiudadDestino;
  }
}
